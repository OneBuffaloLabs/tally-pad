  ...
  return (
    <div className='px-4 py-12 sm:py-16'>
      <div className='max-w-3xl mx-auto prose prose-p:text-foreground/80 prose-li:text-foreground/80 prose-headings:text-secondary prose-h1:text-4xl prose-h1:font-extrabold prose-h2:text-2xl prose-h2:font-bold prose-a:text-primary hover:prose-a:opacity-80'>
        ...
        <p>
          Please read these Terms of Service (&quot;Terms&quot;) carefully before using the TallyPad
        ...
        <p>
          In no event shall One Buffalo Labs or its suppliers be liable for any damages (including,
          without limitation, damages for loss of data or profit, or due to business interruption)
          arising out of the use or inability to use the materials on TallyPad&apos;s website, even
          if we or an authorized representative has been notified orally or in writing of the
