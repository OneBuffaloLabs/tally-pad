  ...
  return (
    <div className='px-4 py-12 sm:py-16'>
      <div className='max-w-3xl mx-auto prose prose-p:text-foreground/80 prose-li:text-foreground/80 prose-headings:text-secondary prose-h1:text-4xl prose-h1:font-extrabold prose-h2:text-2xl prose-h2:font-bold prose-a:text-primary hover:prose-a:opacity-80'>
        ...
        <p>
          TallyPad is designed with a &quote;privacy-first&quote; approach. All game and score data
          you create is stored locally in your web browser&apos;s Local Storage. We do not have a
          server database to store this information. This means:
        </p>
        <ul>
        ...
        <p>
          To understand how our users interact with TallyPad and to help us improve the application,
          we use Google Analytics. This service collects anonymous, aggregated data about user
          behavior, such as which features are used most often and the general flow through the
          application.
        </p>
        <ul>
        ...
        <p>
          ...
          posting the new Privacy Policy on this page. We encourage you to review this page
