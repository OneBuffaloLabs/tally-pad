    ...
    changes: [
      {
        type: 'changed',
        items: [
          '**Scorecard Reliability:** Improved calculation performance for Golf, Yahtzee, and Phase 10.',
          '**Yahtzee Engine:** Complete internal refactor for better stability and speed.',
        ],
      },
      {
        type: 'fixed',
        items: [
          '**Accessibility:** Removed forced auto-focus on score inputs to improve keyboard navigation.',
          '**Winner Calculation:** Fixed a bug where the winner announcement could trigger prematurely.',
        ],
      },
    ],
  },
    ...
    changes: [
      {
        type: 'added',
        items: [
          '**Initial Launch:** Official release of TallyPad!',
          '**Game Support:** Dedicated scorecards for Yahtzee, Phase 10, Golf, Putt-Putt, and Simple Score.',
          '**Core Features:** Unlimited players, game history saving, and mobile-first design.',
        ],
      },
    ],
  },
